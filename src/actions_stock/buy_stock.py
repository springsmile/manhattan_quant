...
class BuyStock2:
    def __init__(self, stock, account, cfg):

        self.stock = stock

        self.account = account
        # 实时股价
        self.stock_price = stock.stock_price

        # 买前现金
        self.before_cash_amount = account.cash_amount

        # 买前股数
        self.before_stock_num = stock.stock_num

        # 报买差价
        self.dif_price = cfg.dif_price
